...
export function getMerchantAfterSaleChatThread(afterSaleId) {
...
export function fetchMerchantChatUnreadCount() {
  return client.get('/chat/unread-count').then((r) => r.data);
}

export function notifyMerchantChatUnreadChanged() {
  if (typeof window !== 'undefined') {
    window.dispatchEvent(new Event('merchant-chat-unread-changed'));
  }
}
